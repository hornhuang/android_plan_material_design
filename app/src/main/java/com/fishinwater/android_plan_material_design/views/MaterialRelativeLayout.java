package com.fishinwater.android_plan_material_design.views;
...
//        final TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.MaterialRelativeLayout);
//        mCirclelColor = typedArray.getColor(R.styleable.MaterialRelativeLayout_mycolor, Color.LTGRAY);
//        mDuration = typedArray.getInteger(R.styleable.MaterialRelativeLayout_duration, DEFAULT_DURATION);
//        mFrameRate = typedArray.getInteger(R.styleable.MaterialRelativeLayout_framerate, DEFAULT_FRAME_RATE);
//        mColorAlpha = typedArray.getInteger(R.styleable.MaterialRelativeLayout_alpha, DEFAULT_ALPHA);
//        mCircleScale = typedArray.getFloat(R.styleable.MaterialRelativeLayout_scale, DEFAULT_SCALE);
